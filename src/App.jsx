...
import './App.css'
import logoImage from './assets/Apex Mechanical-logo.png'
...
const navItems = [
  ...
  { label: 'Why Apex Mechanical', href: '/why-Apex Mechanical' },
...
const serviceGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      'Mechanical system reconfiguration',
    ],
  },
  {
    ...
    items: [
      ...
      'Equipment servicing and adjustments',
...
const whyCards = [
  ...
  },
  {
    ...
    text: 'Mechanical systems require careful planning and precise execution. We coordinate closely with project teams to ensure work is completed safely, efficiently, and according to schedule.',
  ...
  },
  {
    ...
    text: 'Experienced mechanical professionals, compliant jobsite practices, and dependable follow-through keep every project moving forward with confidence.',
  },
]

const differenceItems = [
  'Experienced mechanical professionals',
      ...
      <div className="container hero-grid">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            Apex Mechanical provides professional mechanical services for commercial, industrial, and multifamily construction projects. We install high-performance mechanical systems with precision, efficiency, and schedule-driven execution so buildings operate reliably from day one.
          </p>
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Apex Mechanical was founded on hard work, integrity, and relentless execution in the field."
        dark
      />
      <section className="section about-section">
        <div className="container section-intro">
          <p>
            ...
            evolved into a deep understanding of how mechanical systems must be installed safely,
            strategically, and efficiently.
          </p>
          <p>
            Apex Mechanical was formed to bring that field-earned experience into a company built around
            reliability, technical expertise, and trust.
          </p>
          <p>
            Today, Apex Mechanical provides professional mechanical services to public and private sector
        ...
        <div className="container about-grid">
          <div className="about-copy">
            <h3>Clients rely on Apex Mechanical because we:</h3>
...
function ServicesPage() {
  return (
    <>
      <PageHero
        label="Core Services"
        title="Mechanical systems that keep buildings running."
        subtitle="From system installation and retrofits to equipment setup and mechanical coordination, Apex Mechanical keeps projects moving."
        dark
      />
...
function WhyPage() {
  return (
    <>
      <PageHero
        label="Why Apex Mechanical"
        title="Mechanical Solutions That Keep Projects Moving."
        subtitle="Apex Mechanical delivers professional mechanical services with a focus on coordination, safety, and efficient execution."
        dark
      />
      <section className="section why-section why-page-section">
        <div className="container section-intro centered narrow light-text">
          ...
          <p>
            We help contractors and owners reduce risk, protect timelines, and deliver mechanical systems that perform from day one.
          </p>
        </div>
      ...
      <section className="section difference-section">
        <div className="container difference-wrap">
          <div>
            <p className="section-label">The Apex Mechanical Difference</p>
            <h2>Built to perform under real project conditions.</h2>
            <p>
              We understand that mechanical systems are not just components — they are critical infrastructure that must be installed safely, efficiently, and correctly for long-term building performance.
            </p>
          </div>
        ...
        <div className="container contact-grid">
          <div className="contact-copy">
            ...
            <div className="contact-list">
              ...
              <div>
                <h4>Email</h4>
                <p>info@Apex Mechanical-demo.com</p>
              </div>
              <div>
                <h4>Hours</h4>
...
function App() {
  ...
  const pageTitles = {
    ...
    '/about': 'About',
    '/services': 'Services',
    '/why-Apex Mechanical': 'Why Apex Mechanical',
    '/contact': 'Contact',
  }
  ...
  useEffect(() => {
    document.title = pageTitles[location.pathname] || 'Apex Mechanical'
  }, [location.pathname])
    ...
    <div className="site-shell">
      <header className="topbar">
        <div className="container nav-row">
          <NavLink className="brand" to="/">
            ...
            <span className="brand-text">Apex Mechanical</span>
          </NavLink>
      ...
      <main>
        <Routes>
          ...
          <Route path="/why-Apex Mechanical" element={<WhyPage />} />
  ...
  <div className="container footer-grid footer-grid-compact">
    <div className="footer-company">
      ...
      <p>
        Professional mechanical services built for safety, performance, and dependable
        execution.
      </p>
    </div>
    ...
    <div>
      <h4>Services</h4>
      <div className="footer-links">
        <NavLink to="/services">Mechanical Systems</NavLink>
    ...
    <div className="footer-contact">
      <h4>Get In Touch</h4>
      <div className="footer-links">
        <a href="tel:5550000000">(786) 558-1120</a>
  ...
  <div className="container footer-bottom">
    <p>© 2026 Apex Mechanical. All rights reserved.</p>
